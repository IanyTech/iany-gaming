...
function maybeReduceMotionOnMobile() {
  try {
    ...
    // If user hasn't explicitly chosen reduced, apply a gentler default once
    if (s.effects !== 'minimal' || s.motion !== 'reduced') {
      writeSettings({ effects: 'minimal', motion: 'reduced' });
