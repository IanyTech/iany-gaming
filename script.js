...
function setupWelcomeAuthPrompt() {
  ...
  btnLogin && (btnLogin.onclick = () => { hide(); try { window.openAccountAuth?.('login'); } catch(_) {} });
  btnRegister && (btnRegister.onclick = () => { hide(); try { window.openAccountAuth?.('register'); } catch(_) {} });
